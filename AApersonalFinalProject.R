...
#### WORK ####
## Part 2
# Matt - GML and Elec04 data, bulk of merging work
...
### Note: Inequalities in work for part 1 will be addressed by
### reduced works in part 2

## Group meetings: Tuesday 11/27 (All); Thursday 11/29 (M/T/A);
## Saturday 12/1 (All); Sunday 12/2 (M/A/S); Monday 12/3 (M/A)
...
VarsToKeep = c(3:1, 4:9, EducationNums, FertNums, CitizenNums, 21, 41, 73, 85, 159,
               163, 212, 249, 259, 415,732, 740, 747, 767)
...
names(FinalDF)[10:38] = c("Gr1-8.Enroll", "HS.Enroll", "College.Enroll",
                          ...
                          "IncomePerCapita", "languages.spanish","languages.aryan","languages.asia","TotalHouseholds")
